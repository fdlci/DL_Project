...
def train_pre_trained_model_ResNet(pre_trained_model, data_dir):
...
def main_train_ResNet(data_dir):
    """Builds and trains the model"""
    ...
    # Training Model
    model_trained = train_pre_trained_model_ResNet(model_ft, data_dir)
...
model_ft = main_train_ResNet(data_dir)
